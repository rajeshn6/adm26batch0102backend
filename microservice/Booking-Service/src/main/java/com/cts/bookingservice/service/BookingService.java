...
import com.cts.bookingservice.feignclient.BookingServiceToMechanicService;
import com.cts.bookingservice.feignclient.BookingServiceToUserService;
...
public class BookingService {
	...
	@Autowired
	private BookingServiceToMechanicService bookingServiceToMechanicService;
	
	@Autowired
	private BookingServiceToUserService bookingServiceToUserService;
	@Autowired
	...
	public String getBookingStatus(@PathVariable int bookingId) {
		//MECHANI-SERVICE - ip port
		// mechanix-api/mechanics/1
		MechanicResponseDto dto=bookingServiceToMechanicService.mechanicById(100);
		System.out.println(dto);
		String user=bookingServiceToUserService.getUser("meena.kit@gmail.com").toString();
